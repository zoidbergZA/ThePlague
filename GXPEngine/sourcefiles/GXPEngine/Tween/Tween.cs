...
namespace Glide
{
    ...
    {
        private readonly List<float> end;
        private readonly List<float> range;
        private readonly List<float> start;
