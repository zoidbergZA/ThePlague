...
namespace Glide
{
    ...
    public partial class Tween
    {
        public class TweenerImpl
        {
            ...
            private static readonly object _dummy;
            ...
            public Tween Tween<T>(T target, object values, float duration, float delay = 0) where T : class
            {
                ...
                foreach (PropertyInfo property in values.GetType().GetProperties())
                {
                    ...
                    float to = Convert.ToSingle(new GlideInfo(values, property.Name, false).Value);
            ...
            private void AddAndRemove()
            {
                ...
                foreach (Tween remove in toRemove)
                {
                    List<Tween> list;
            ...
            /// <summary>
            ///     Look up tweens by the objects they target, cancel them, set them to their final values, and call the complete
            ///     callback.
            /// </summary>
